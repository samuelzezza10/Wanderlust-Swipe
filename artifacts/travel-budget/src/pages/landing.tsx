...
import { Plane, Hotel, Train, Zap, Shield, Heart, Mail } from "lucide-react";
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col overflow-hidden relative bg-[hsl(215,85%,48%)]">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pb-8 text-center">
        ...
        >
          Scorri le offerte come su Tinder, salva i viaggi che ti piacciono e confronta voli, treni e hotel in un colpo solo. Gratis, senza registrazione obbligatoria.
        </motion.p>
