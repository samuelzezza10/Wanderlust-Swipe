...
const clerkAppearance = {
  ...
  elements: {
    ...
    headerTitle: "text-foreground font-extrabold text-2xl",
    headerSubtitle: "text-foreground/80 font-medium",
    ...
    footerActionText: "text-foreground/80 font-medium",
    dividerText: "text-foreground/70 font-medium",
